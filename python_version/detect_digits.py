...
# Loading the weights
model.load_state_dict(torch.load('/home/node/Downloads/imagerecaptcha/recaptcha/model_final.ckpt'))

# Eval mode (batchnorm uses moving mean/variance instead of mini-batch mean/variance)
model.eval()

image = cv2.imread("/home/node/Downloads/imagerecaptcha/recaptcha/assets/test.png")
